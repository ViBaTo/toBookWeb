...
const data = [
  {
    value: 73,
    text: 'Consultas perdidas por no responder en los primeros 5 minutos'
  },
  {
    value: 47,
    text: 'Incremento en reservas con respuesta automática instantánea'
  },
  {
    value: 81,
      ...
      <section className='percentages-section'>
        {data.map((item, idx) => (
          <div className='percentage-block' key={idx}>
            {animate ? (
              <CounterCircle value={item.value} />
            ) : (
              <CounterCircle value={0} />
            )}
